...
class Level extends Game {
  ...
  constructor(canvasId) {
    ...
    const platforms = [
      ...
      new Platform(1817, -173, 100.0, 138, "rgb(128, 128, 128)", "platform"),
      new Platform(5231.0, 1096.0, 20.0, 20.0, "rgb(255, 128, 192)", "speed"),
      new Platform(4149, -1444, 100, 100, "rgb(128, 128, 128)", "platform"),
      ...
      new Platform(2049.0, 1630.0, 498.0, 100, "rgb(128, 255, 255)", "flipper"),
      ...
      new Platform(1759.0, 1363.0, 193.0, 100, "rgb(128, 128, 128)", "platform"),
      ...
      new Platform(3105.0, 1630.0, 250.0, 100, "rgb(255, 0, 0)", "bad"),
      new Platform(4896.0, 500.0, 262.0, 749.5, "rgb(128, 128, 128)", "platform"),
      ...
      new Platform(4173.0, 1680.0, 732.0, 100, "rgb(128, 255, 255)", "flipper"),
      ...
      new Platform(6156.0, -525.0, 1249.0, 981.0, "rgb(128, 128, 128)", "platform"),
    ...
    const player = new Player(1793, 1267);
